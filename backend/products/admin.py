...
class SolarPackageAdmin(admin.ModelAdmin):
    list_display = ('name', 'system_size_kw', 'recommended_for', 'total_price', 'deposit_amount', 'payment_type', 'installment_months', 'is_active', 'is_popular', 'display_order')
    ...
    fieldsets = (
        ...
        ('Pricing & Payment', {
            'fields': ('total_price', 'deposit_amount', 'payment_type', 'installment_months', 'installation_included')
        }),
        ('Equipment & Powers', {
