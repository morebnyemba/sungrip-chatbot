...
echo "  - Frontend: https://zimgrow.shop (or http://localhost for local dev)"
echo "  - Admin Panel: https://api.zimgrow.shop/admin (or http://localhost/admin for local dev)"
echo "  - API: https://api.zimgrow.shop/api (or http://localhost/api for local dev)"
echo ""
