...
echo "  - Frontend: https://sungrip.slykertech.co.zw (or http://localhost for local dev)"
echo "  - Admin Panel: https://sungripapi.slykertech.co.zw/admin (or http://localhost/admin for local dev)"
echo "  - API: https://sungripapi.slykertech.co.zw/api (or http://localhost/api for local dev)"
echo ""
