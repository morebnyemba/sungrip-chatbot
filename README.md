...
6. **Access the application**
   ...
   - Admin Panel: https://sungripapi.slykertech.co.zw/admin (or http://localhost/admin for local dev)
   - API: https://sungripapi.slykertech.co.zw/api (or http://localhost/api for local dev)
...
2. **Configure Webhook**
   - Set webhook URL: `https://sungripapi.slykertech.co.zw/webhook/`
